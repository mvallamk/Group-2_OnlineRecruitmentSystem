...
<body background="images/bg1.jpg">
	<center>
		...
		<br> <br> <br> <br> <a class="two"
			href="addqualform.htm">Add Qualification Details</a>
				...
				<table bgcolor="#E4E47C" cellspacing="5" align="center" border="1">
					...
					<tr align=center valign=middle>
						...
						<td><form:input path="percentage"
								pattern="[0-9]+(\.[0-9]{0,2})?%?" required="TRUE"
								title="This must be a number with up to 2 decimal places"></form:input>
		...
		<br> <br> <br> <br> <a class="two"
			href="addworkform.htm">Add Work History Details</a>
				...
				<table bgcolor="#E4E47C" cellspacing="5" align="center" border="1">
					<tr align=center valign=middle>
						...
						<td><form:input path="whichEmployer"
								...
								title="Previous1"></form:input> <form:errors
								path="whichEmployer"></form:errors></td>
					</tr>
					<tr align=center valign=middle>
